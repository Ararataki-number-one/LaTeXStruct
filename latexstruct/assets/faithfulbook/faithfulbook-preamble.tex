...
\IfFileExists{microtype.sty}{%
  ...
  % XeTeX supports protrusion, but microtype's tracking implementation is
  % pdfTeX/LuaTeX-only and raises a package error under XeLaTeX.  Keep the
  % engine-neutral feature enabled and explicitly disable unsupported ones.
